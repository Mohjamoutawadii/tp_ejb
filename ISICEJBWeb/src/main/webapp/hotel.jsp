    ...
    <div class="row justify-content-center">
        <div class="col-md-6 form-container">
            ...
            <div class="title-icon">
                ...
                <h2 class="text-center mb-4">Gestion des Hôtels</h2>
            </div>
            ...
            <form action="HotelController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="telephone" type="tel" class="form-control" id="telephone" placeholder="Entrez votre numéro de téléphone">
                </div>
                <div class="form-group">
                ...
                <button type="submit"  name="action" value="create"  class="btn btn-enregistrer btn-block mx-auto">Enregistrer</button>
